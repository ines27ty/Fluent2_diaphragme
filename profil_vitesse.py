...
# Tracé du Profil de vitesse laminaire de toutes les lignes
plt.figure(7)
plt.plot(V_lam_e,x_lam_e,label='V_lam_e')
plt.plot(V_lam_19,x_lam_19,label='V_lam_19')
plt.plot(V_lam_or,x_lam_or,label='V_lam_or')
plt.plot(V_lam_21,x_lam_21,label='V_lam_21')
plt.plot(V_lam_25,x_lam_25,label='V_lam_25')
plt.plot(V_lam_30,x_lam_30,label='V_lam_30')
plt.plot(V_lam_s,x_lam_s,label='V_lam_s')
plt.xlabel('V')
plt.ylabel('y')
plt.title("Profil de vitesse laminaire")
plt.grid()
plt.legend()

# Tracé du Profil de vitesse turbulent de toutes les lignes
plt.figure(8)
plt.plot(V_turb_e,x_turb_e,label='V_turb_e')
plt.plot(V_turb_19,x_turb_19,label='V_turb_19')
plt.plot(V_tur_or,x_tur_or,label='V_tur_or')
plt.plot(V_tur_21,x_tur_21,label='V_tur_21')
plt.plot(V_tur_25,x_tur_25,label='V_tur_25')
plt.plot(V_tur_30,x_tur_30,label='V_tur_30')
plt.plot(V_tur_s,x_tur_s,label='V_tur_s')
plt.xlabel('V')
plt.ylabel('y')
plt.title("Profil de vitesse turbulent")
plt.grid()
plt.legend()
